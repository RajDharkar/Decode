...
@Config
@TeleOp(name = "Shooter + Kicker Tester")
public class ShooterKickerTester extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        gp1.getGamepadButton(GamepadKeys.Button.LEFT_BUMPER).whenPressed(new ShooterCommand(robot, Shooter.ShooterState.CLOSE));
        ...
        while (opModeIsActive()) {
            ...
            MyTelem.addData("Shooter State", robot.shooter.state);
